...
<!--===============================================================================================-->
    ...
    <body>
		...
		<div class="container-login100"  >
			<div class="wrap-login100"style="background-color:gray;">
		...
		<span class="focus-input100"></span>
			...
			<div class="container-login100-form-btn" style="background-color:bisque;" >
                        <button onclick="return checkForEmptyFieldsofLogin();" class="login100-form-btn"  style="background-color:navy;" >
