<%-- 
    Document   : DetailsOfSelectedMovie
    Created on : May 2, 2020, 7:53:48 PM
    Author     : abc
--%>
...
<body class="homepage" style="">
  ...
  <div style="position: relative;text-align: center;color: white;">
    <img src="content/i4.jpg" class="img-responsive centerd" style="max-width:100%;max-height:100%; border-radius: 6px;" alt="image">
    <div style="position: absolute;top: 50%; left: 50%;transform: translate(-50%, -50%);">
        <div style="background-color:#660C23;border-radius: 3px;">
        <h2 style="border: 20px; text-align: center;font-family: serif;font-size: 20px;"><%=c.getName()%></h2>
        <h2 style="border: 20px; text-align: center;font-family: serif;font-size: 20px;"><%=m.getTitle()%></h2>
        <h2 style="border: 20px; text-align: center;font-family: serif;font-size: 20px;">Movie Description</h2>
        <p style="border: 20px; text-align: center;font-family: serif;font-size: 20px;"><%=m.getDescription()%></p>
        <h2 style="border: 20px; text-align: center;font-family: serif;font-size: 20px;">Average Rating: <%=m.avgRating()%></h2>
        </div>
        <button class="button1" style=" cursor: pointer; font-size: 16px;background-color: #257854; border-color: #257854;margin: 10px;" formaction="GiveFeedback.jsp">
            <a href="GiveFeedback.jsp" style="color: white;">Give Feedback</a></button>
            <button class="button1" style=" font-size: 16px;cursor: pointer; background-color: #257854; border-color: #257854;margin: 10px;" formaction="seatingPlan.jsp">
        <a href="seatingPlan.jsp" style="color: white;">
            
           <button onclick="document.location='seatingPlan.jsp'">HTML Tutorial</button>
        Go to Seat Selection</a></button>
    </div>
  </div>
	...
	<div style="border:6px double #660C23;height: 200px;"><h2 style="margin-left: 550px;font-size: 30px;font-family: serif;">Top Rated Movies</h2>
		<ul style="list-style-type: circle;margin-left: 30px;margin-top:20px;color: white;">
                        ...
                        ArrayList<Movie> mm=obj.displayTopRatedMovies();
                        %>
                        <%for (int i=0;i<mm.size();i++)
                        {%>
                            <li style="font-size: 25px;padding: 8px; font-family: serif;"><%=mm.get(i).getTitle()%></li>
                        <%}%>
