	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="signupServlet" style="background-color:bisque;">
					<span class="login100-form-title p-b-34">
						Account Signup
					</span>
					
					<div class=" validate-input m-b-20" data-validate="Type name">
					...
					<div class=" validate-input m-b-20" data-validate="Type age">
						<input class="input100" type="number" name="age" placeholder="Age" min="1">
						<span class="focus-input100"></span>
					</div>
					

					<div class=" validate-input m-b-20" data-validate="Type contact">
						<input class="input100" type="number" name="contact" placeholder="Contact">
						<span class="focus-input100"></span>
					</div>

					<div class=" validate-input m-b-20" data-validate="Type email id">
					...
					<div class=" validate-input m-b-20" data-validate="Type password">
					...
					<div class="container-login100-form-btn">
						<button onclick="return checkForEmptyFieldsofLogin();" style="background-color:bisque;">
							<a href="login.jsp" style="color: black;">
							Sign Up
						</a>
						</button>
					</div>
				...
				<div class="login100-more" style="background-image: url('content/images/logo.jpg');"></div>
			</div>
		</div>
	</div>
