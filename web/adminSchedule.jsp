    ...
    {%>
        ...
        {%>
            ...
            <input type="hidden" name="sl" value="<%=ss.get(j).getSlot().getStartTime()%>" >
                ...
                <th><input name="<%=jj%>" style="color: black;" type="submit" value="Update"></th>
                <th><input name="<%=jj%>" style="color: black;" type="submit" formaction="DeleteScheduleServlet" value="Delete"></th>
            </tr>
        <%}%>
            </table>
                    </form>
